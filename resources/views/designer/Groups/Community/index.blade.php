...
@section('content')
    ...
    @section('designer-groups-menu')
        ...
        <li><a href="{{ url('designer/groups/'.$group->unique_id.'/community') }}" class="waves-effect waves-light active">Community</a></li>
...
@endsection
    @section('footerscript')
        <script type="text/javascript">
            var URL = '{{url("designer/imageUpload")}}';
            var URL1 = '';
            var CLOSE = '{{asset('resources/assets/marketplace/images/close.png')}}';
            var communityURL = '{{ url("designer/groups/".$group->id) }}';
        </script>
        <style>
            .fa-pencil{
            ...
            $container.infiniteScroll({
                ...
                path: function() {
                    ...
                    if(this.loadCount <= {{$timeline->lastPage()}}){
                        ...
                        return '{{url("designer/groups/".$group->unique_id."/community?page=")}}'+pageNumber;
                    }
