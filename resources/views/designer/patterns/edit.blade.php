				...
				<div class="card">
					<div class="row">
						<div class="col-lg-12">
							...
							<!-- ul tabs -->
							<form class="form-horizontal" id="create-pattern" action="{{ route('update.pattern') }}"  method="post">
													...
													<div class="card-block collapse" id="section5">
														<div class="row">
															<div class="form-group col-md-4 m-b-20">
																...
																<input type="text" name="product_price" id="product_price" class="form-control" placeholder="Enter price" value="{{ $pattern->product_price }}">
															</div>
															<div class="form-group col-md-4 m-b-20">
...
if (result.value) {
if(server){
	$.get('{{ url("designer/deleteYarnRecommmendations")  }}/'+id,function (res){
...
if (result.value) {
if(server){
	$.get('{{ url("designer/deleteNeedles")  }}/'+id,function (res){
		if(res.status == 'success'){
			$("#needle-"+id).remove();
...
$(".loading,.loader-bg").show();
$.post('{{ route("make.image.default") }}', Data, function(result) {
	if(result.status == 'success'){
