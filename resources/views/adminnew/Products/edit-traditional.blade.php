...
<!-- col-md-12 -->
<div class="col-xl-12">
<label class="theme-heading f-w-600 m-b-20">Update Pattern</label>
...
<div class="card">
    <div class="row">
        <div class="col-lg-12">
            ...
            <!-- ul tabs -->
            <form class="form-horizontal" id="create-pattern" action="{{ route('adminnew.update.traditional.pattern') }}"
                  method="post">
                <input type="hidden" id="pattern_id" name="pattern_id" value="{{ encrypt($pattern->id) }}" />
                                    ...
                                    <div class="custom-card-block" id="section1">
                                        <div class="form-group row">
                                            <div class="col-md-4 m-b-20">
                                                ...
                                                <input type="text" name="sku" id="sku" class="form-control" value="{{ $pattern->sku }}" readonly >
                                            </div>
                                            <div class="col-md-4 m-b-20">
                                                <label class="form-label">Pattern GoLive Date<span class="red">*</span>
                                                </label>
                                                <input type="text" name="pattern_go_live_date" readonly placeholder="Please select date" id="pattern_go_live_date" class="form-control" value="{{date('m/d/Y',strtotime($pattern->pattern_go_live_date))}}" >
                                            </div>
                                            <div class="col-md-4 m-b-20">
                                                ...
                                                <select class="form-control" name="status" id="status" >
                                                    ...
                                                    <option value="0" @if($pattern->status == 0) selected @endif >Inactive</option>
                                                    <option value="1" @if($pattern->status == 1) selected @endif >Active</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="step">
                                            <div class="form-group row">
                                                <div class="col-md-6 m-b-20">
                                                    ...
                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter pattern name" value="{{ $pattern->name }}">
                                                </div>
                                                <div class="col-md-6 m-b-20">
                                                    <label class="form-label">Designer name<span class="red">*</span>
                                                    </label>
                                                    <input type="text" class="form-control" id="designer_name" name="designer_name" placeholder="Enter designer name" value="{{ $designer->name }}">
                                                ...
                                                <div class="col-md-6 m-b-20">
                                                    ...
                                                    <select class="form-control form-control-default" id="skill_level" name="skill_level" >
                                                        ...
                                                        <option value="Beginner" @if($pattern->skill_level == 'Beginner') selected @endif >Beginner</option>
                                                        <option value="Easy" @if($pattern->skill_level == 'Easy') selected @endif >Easy</option>
                                                        <option value="Intermediate" @if($pattern->skill_level == 'Intermediate') selected @endif >Intermediate</option>
                                                        <option value="Complex" @if($pattern->skill_level == 'Complex') selected @endif >Complex</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-12 m-b-20">
                                                    <label class="form-label">Pattern description<span class="red">*</span>
                                                    </label>
                                                    <textarea id="pattern_description" name="pattern_description" class="form-control summernote" spellcheck="false">{!! $pattern->pattern_description !!}</textarea>
                                                </div>
                                                <div class="col-md-12 m-b-20">
                                                    <label class="form-label">Pattern details<span class="red">*</span>
                                                    </label>
                                                    <textarea  id="short_description" name="short_description" class="form-control summernote">{!! $pattern->short_description !!}</textarea>
                                                </div>
                                                <div class="col-md-12 m-b-20">
                                                    <label class="form-label">Gauge instruction<span class="red">*</span></label>
                                                    <textarea id="gauge_description" name="gauge_description" class="form-control summernote">{!! $pattern->gauge_description !!}</textarea>
                                                </div>
                                                <div class="col-md-12 m-b-20">
                                                    <div class="form-group">
                                                        <label class="form-label">Materials needed<span class="red">*</span></label>
                                                        <textarea id="material_needed" name="material_needed"  class="form-control summernote">{!! $pattern->material_needed !!}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 m-b-20">
                                                    <?php
                                                    $tags = explode(',',$pattern->design_elements);
                                                    ?>
                                                ...
                                                <div class="col-md-4 m-b-20">
                                                    <div class="form-group m-t-10">
                                                        <?php
                                                        $tags2 = explode(',',$pattern->construction_technique);
                                                        ?>
                                                        ...
                                                        <select class="select" multiple="multiple"
                                                            ...
                                                            @if(count($tags2) > 0)
                                                                @for($k=0;$k<count($tags2);$k++)
                                                                    <option value="{{ $tags2[$k] }}" selected >{{
                                                                    $tags2[$k] }}</option>
                                                                @endfor
                                                            @else
                                                                @foreach($garmentConstruction as $gs)
                                                                    <option value="{{ $gc->slug }}" >{{ $gc->name
                                                                    }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                ...
                                                <div class="col-md-4 m-b-20">
                                                    <div class="form-group m-t-10">
                                                        <?php
                                                        $tags3 = explode(',',$pattern->garment_type);
                                                        ?>
                                                ...
                                                <div class="col-md-4 m-b-20">
                                                    <?php
                                                    $tags1 = explode(',',$pattern->shoulder_construction);
                                                    ?>
                                                    <div class="form-group m-t-10">
                                                        ...
                                                        <select class="select" multiple="multiple" id="shoulder_construction" name="shoulder_construction[]" style="width: 100%;">
                                                            @if(count($tags1) > 0)
                                                                @for($j=0;$j<count($tags1);$j++)
                                                                    <option value="{{ $tags1[$j] }}" selected >{{ $tags1[$j] }}</option>
                                                                @endfor
                                                            @else
                                    ...
                                    <div class="custom-card-block collapse" id="section2">
                                        <div class="row col-md-12" id="yarnDetails">
                                            @if($pattern->yarnRecommmendations()->count() > 0)
                                                <?php $y=0; ?>
                                                @foreach($pattern->yarnRecommmendations as $yarns)
                                                    <div class="form-group row m-b-zero yarnRows" id="yarn-row-{{$y}}">
                                                        <input type="hidden" name="p_pattern_yarn_recommendations_id[]" value="{{ $yarns->id }}">
                                                        @if($y == 0)
...
<span class="tooltip-text" style="width: 100%;">Select the needle size from the dropdown.</span>
                                        ...
                                        <div class="row form-group m-b-zero" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label class="form-label f-w-600 black">
                                                            Designer's gauge
                                                            <span class="mytooltip tooltip-effect-2">
<span class="tooltip-item">?</span>
<span class="tooltip-content clearfix">
...
<span class="tooltip-text f-w-200 f-14" style="width: 100%;">The designer's gauge is only provided for the reference of curious knitters. Only your own gauge matters for custom patterns!</span>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="stitch_gauge_in" name="stitch_gauge_in">
                                                                        ...
                                                                        @foreach($gaugeconversion as $gc2)
                                                                            <option value="{{$gc2->id}}" {{ ($gc2->id == $pattern->stitch_gauge_in) ? 'selected' : '' }}>{{$gc2->row_gauge_inch .' / 1 inches'}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="row_gauge_in" name="row_gauge_in">
                                                                        <option value="">Select value (inches)</option>
                                                                        @foreach($gaugeconversion as $gc2)
                                                                            <option value="{{$gc2->id}}" {{ ($gc2->id == $pattern->row_gauge_in) ? 'selected' : '' }} >{{$gc2->row_gauge_inch .' / 1 inches'}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="ease_in" name="ease_in">
                                                                        <option value="">Select value (inches)</option>
                                                                        @for($j=1;$j<= 20;$j+= 0.25)
                                                                            <option value="{{$j}}" {{ ($j == $pattern->ease_in) ? 'selected' : '' }} >{{$j}}"</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="stitch_gauge_cm" name="stitch_gauge_cm">
                                                                        ...
                                                                        @foreach($gaugeconversion as $gc3)
                                                                            <option value="{{$gc3->id}}" {{ ($gc3->id == $pattern->stitch_gauge_cm) ? 'selected' : '' }}>{{$gc3->rows_10_cm .' / 10cm'}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="row_gauge_cm" name="row_gauge_cm">
                                                                        <option value="">Select value (cm)</option>
                                                                        @foreach($gaugeconversion as $gc3)
                                                                            <option value="{{$gc3->id}}" {{ ($gc3->id == $pattern->row_gauge_cm) ? 'selected' : '' }} >{{$gc3->rows_10_cm .' / 10cm'}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="ease_cm" name="ease_cm">
                                                                        <option value="">Select value (cm)</option>
                                                                        @for($i=1;$i <= 20;$i++)
                                                                            <option value="{{$i}}" {{ ($i == $pattern->ease_cm) ? 'selected' : '' }}>{{$i}} cm</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="card-block collapse" id="section6">
                                        <div class="row">
                                            @if($pattern->patternImages()->count() > 0)
                                                @foreach($pattern->patternImages as $images)
                                    ...
                                    <div class="row theme-row m-b-10">
                                        <div class="card-header accordion col-lg-12"
                                             data-toggle="collapse" data-target="#section9">
                                            <h5 class="card-header-text">Upload pattern pdf / instruction file (DOC, DOCX, PDF, PNG, JPEG)</h5>
                                            <i class="fa fa-caret-down pull-right micro-icons"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-block collapse" id="section9">
                                        <!-- File upload card start -->
                                        <div class="row">
                                            @if($pattern->traditionalPatternpdf()->count() > 0)
                                                @foreach($pattern->traditionalPatternpdf as $inst)
                                                    <div class="col-lg-2 m-b-10 patternImages" id="patternImage{{$inst->id}}">
                                                        <div class="img-hover" style="width:
                                                            ...
                                                            <div class="editable-items" >
                                                                ...
                                                                <a class="fa fa-trash deleteImage" data-server="true" href="javascript:;" data-id="{{ $inst->id }}"></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="card-block collapse" id="section5">
                                        <div class="row">
                                            <div class="form-group col-md-4 m-b-20">
                                                ...
                                                <input type="text" name="product_price" id="product_price" class="form-control" placeholder="Enter price" min="0" value="{{ $pattern->product_price }}">
                                            </div>
                                            <div class="form-group col-md-4 m-b-20">
                                                <label class="form-label">Sale Price
                                                </label>
                                                <input type="number" name="sale_price" id="sale_price" class="form-control" placeholder="Enter sale price" min="0" value="{{ $pattern->sale_price }}">
                                                <span class="red sale_price"></span>
                                            </div>
                                            <div class="form-group col-md-4 m-b-20">
                                                <label class="form-label m-b-0">Sale Price Start Date</label>
                                                <input type="text" name="sale_price_start_date" id="sale_price_start_date" class="form-control validateAfter" readonly placeholder="Select sale price start date" value="{{ $pattern->sale_price_start_date }}">
                                                <span class="red sale_price_start_date"></span>
                                            </div>
                                            <div class="form-group col-md-4 m-b-20">
                                                <label class="form-label">Sale Price End Date
                                                </label>
                                                <input type="text" name="sale_price_end_date" id="sale_price_end_date" class="form-control validateAfter" readonly placeholder="Select sale price end date" value="{{ $pattern->sale_price_end_date }}">
                                                <span class="red sale_price_end_date"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="m-t-20">
                                        <div class="col-sm-12">
                                            <div class="text-center m-b-10">
                                                <button type="submit" class="btn theme-btn btn-primary waves-effect waves-light m-l-10" >Update Pattern</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    var URL = '{{url("adminnew/upload-admin-pattern-images")}}';
    var URL1 = '{{url("adminnew/remove-pattern-images")}}';

    var URL2 = '{{url("adminnew/upload-admin-recomondation-images")}}';
    var URL3 = '{{url("adminnew/remove-admin-recomondation-images")}}';

    var URL4 = '{{url("adminnew/upload-admin-pattern-instructions")}}';
    var URL5 = '{{url("adminnew/remove-admin-pattern-instructions")}}';
...
.img-hover:hover .editable-items{
    top: 50% !important;
...
<script src="{{ asset('resources/assets/files/assets/pages/filer/admin-pattern-instructions.js')}}" type="text/javascript"></script>
...
var value = $("#sale_price_start_date").val();
...
var value = $("#sale_price_end_date").val();
if(value == '0000-00-00' || value == ''){
...
sale_price: {
message: 'The sale price is not valid',
validators: {
notEmpty: {
message: 'The sale price are required.'
},
callback: {
...
validators: {
notEmpty: {
message: 'The sale price start date is required.'
}
}
},
sale_price_end_date: {
...
validators: {
notEmpty: {
message: 'The sale price end date is required.'
}
}
},
...
var patternImagesLength = $(".patternImages").length;
var imageLength = $("li.jFiler-item").length;
...
if(patternImagesLength == 0 && imageLength == 0){
//notification('fa-times','Error','Please add pattern images in images section','danger');
er+=cnt+1;
}
/*
...
setTimeout(function(){ $(".loading,.loader-bg").hide(); },1000);
notification('fa-check','success','Pattern saved successfully.','success');
setTimeout(function(){ window.location.assign(result.url) },1500);
}else{
...
var $validateAfter = $(".validateAfter");
$validateAfter.on('change',function (){
...
if (result.value) {
if(server){
$.get('{{ url("adminnew/deleteYarnRecommmendations")  }}/'+id,function (res){
...
if (result.value) {
if(server){
$.get('{{ url("adminnew/deleteNeedles")  }}/'+id,function (res){
if(res.status == 'success'){
$("#needle-"+id).remove();
...
if(server){
alert('coming here')
$.get('{{ url("adminnew/delete-yarn-image")  }}/'+id,function (res){
if(res.status == 'success'){
...
if (result.value) {
if(server){
$.get('{{ url("adminnew/delete-pattern-image")  }}/'+id,function (res){
if(res.status == 'success'){
...
$(".loading,.loader-bg").show();
$.post('{{ route("adminnew.make.image.default") }}', Data, function(result) {
if(result.status == 'success'){
