                            ...
                            @endphp
                                        @if($IfConditions->count() > 0)
                                            ...
                                            @foreach($IfConditions as $ifcond)
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="card-header m-b-5 snippet{{$se}} mt-10" role="tab" id="headingOne12{{$ifcond->id}}{{$se}}{{$function->id}}" style="background-color: #dedddd;width:100%;">
                                                            <a data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne12{{$ifcond->id}}{{$se}}{{$function->id}}" aria-expanded="true" aria-controls="collapseOne1">
                                                                <h5 class="mb-0">Conditional Variable : {{ $ifcond->condition_variable }}</h5>
                                                                <i class="fa fa-caret-down pull-right micro-icons"></i>
                                                            </a>
                                                        </div>

                                                        <div id="collapseOne12{{$ifcond->id}}{{$se}}{{$function->id}}" class="collapse snippets mb-10 col-md-12 row" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordionEx">
                                                    ...
                                                    @foreach($snip->snippetConditionalStatements as $snipCond)
                                                        ...
                                                        <div id="collapseOne1{{$snipCond->id}}{{$k}}{{$se}}{{$function->id}}" class="collapse snippets{{$se}}{{$snipCond->id}}" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordionEx">
                                                            ...
                                                            <!-- <h5 class="m-t-10 text-danger">PART-{{ $n }}</h5> -->
                                                                ...
                                                                @component('adminnew.Pattern-Templates.summernote', ['condId' => $snipCond->id,'k' => $k,'dataCount' => $se,'l' => $n.''.$function->id,'outputVariables' => $function->outputVariables,'measurements' => $measurements]) @endcomponent
                                                                <?php $n++; ?>
                                                            @endforeach
                                                            <br>
                                                        </div>
