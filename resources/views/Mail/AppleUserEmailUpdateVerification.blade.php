                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px">
                                          ...
                                          <span style="color: #0d665c;"></span> Thanks for merging account! <br> Please click below to activate your account!
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; line-height: 26px;">
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="{{url('api/profile/verify-user/'.$details['token'])}}" style="color: #ffffff; text-decoration: none;">MERGE ACCOUNTS NOW</a>
                                        </div>
                                    </td>
                                </tr>
