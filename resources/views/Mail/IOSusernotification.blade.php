...
<head>
    ...
    <title>StitchersStudio | Activate Account</title>
...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 20px;line-height: 35px;" class="main-header">
                                ...
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; line-height: 24px;">
                                        ...
                                        <div style="line-height: 24px;font-size: 14px;font-family: myriad-pro, sans-serif;">
                                            ...
                                            There are few things you need to know before using the mobile StitchersStudio App.
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" align="center" width="160" cellpadding="0" cellspacing="0" style="background-color: #0d665c;">
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; line-height: 26px;">
                                        ...
                                        <div style="line-height: 26px;font-size: 20px;font-family: myriad-pro, sans-serif;">
										@auth
											@if(Auth::user()->isFree())
												<a href="{{ url('new-subscriber') }}" style="color: #ffffff; text-decoration: none;">Get started</a>
											@else
												<a href="{{ url('existing-subscriber') }}" style="color: #ffffff; text-decoration: none;">Get started</a>
											@endif
										@endauth
    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="bg_color">
        ...
        <tr>
            <td height="10" style="border-top: 1px solid #e0e0e0;font-size: 20px; line-height: 20px;">&nbsp;</td>
        </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email us: <a href="mailto:" style="color: #888888; font-size: 14px; font-weight: 400;">support@stitchersstudio.com</a><br><a href="Unsubscribe.html" style="color: #888888; margin-left:0px;font-size: 14px; font-weight: 400;">Unsubscribe</a>
                    ...
                    <tr>
                        <td>
                            <table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <td align="center" style="color: #aaaaaa; font-size: 14px; line-height: 24px;">
