                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 10px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    ...
                                    <h2 style="margin-bottom: 20px;text-align: center;">Support ticket resolved.</h2>
                        ...
                        <tr>
                            <td style="padding: 10px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p style="margin: 0;">
                                    ...
                                    <a href="{{ url('admin/support/'.$support['ticket_id'].'/show') }}">{{ $support['ticket_id'] }}</a>
                                    @else
                                        <a href="{{ url('support/'.$support['ticket_id'].'/show') }}">{{ $support['ticket_id'] }}</a>
                                    @endif
                                </p>
                            </td>
                        </tr>
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td style="padding: 10px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                ...
                                <p style="margin: 0;">@if($support['priority'] == 1)
                                        Low
