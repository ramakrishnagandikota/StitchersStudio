...
You have only {{Auth::user()->remainingDays()}} days of subscription left. Your subscription ends on {{date('d/F/Y',strtotime(Auth::user()->sub_exp))}}.
</div>
@else
<div class="col-lg-12 alert alert-success">
You have {{Auth::user()->remainingDays()}} days of subscription. Your subscription ends on {{date('d/F/Y',strtotime(Auth::user()->sub_exp))}} .
</div>
@endif
