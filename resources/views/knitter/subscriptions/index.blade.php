...
<table class="table table-styling table-info" id="subscription-table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <th>Share photos, projects, and updates</th>
            <td class="text-center Free"><i class="fa fa-check green-checkmark"></i></td>
            <td class="text-center Basic"><i class="fa fa-check green-checkmark"></i></td>
        ...
        <tr>
            <!-- <th>Shopping</th> -->
            <th>Upload pattern pdf's for mobile use</th>
        ...
        <tr>
            ...
            <th>Generate custom size patterns</th>
            <td class="text-center Free"><i class="fa fa-check green-checkmark"></i></td>
            <td class="text-center Basic"><i class="fa fa-check green-checkmark"></i></td>
        ...
        <tr>
            ...
            <th>Store measurement profiles</th>
            <td class="text-center Free">1</td>
            <td class="text-center Basic" style="color: #0d665c;font-weight: bold;">UNLIMITED</td>
