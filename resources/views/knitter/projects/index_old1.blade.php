...
@endif
     ...
     <div class="col-xl-8 text-right tabber">
      ...
      @else
        <a href="#" style="pointer-events: none;opacity: 0.5;" class="btn btn-theme tablike-bt-fill waves-effect">Create Project</a>
      @endif
...
@php 
$projects = Auth::user()->projects()->where('is_archive',0)->where('is_deleted',0)->first();
@endphp
                    ...
                    <div class="col-md-12 m-b-20">
                       <div class="card-sub-custom">
                          <div class="card-block">
                            ...
                            @endif
                                <div class="f-10"><strong>Measurement profile :</strong> {{ $title }}</div>
                                </div>
                             </div>
                          </div>
                          <div class="card-footer-custom">
        ...
        <div class="card-block">
           <div class="row">
              ...
              <ul  id="sortable3" class='droptrue'>
                ...
                $image2 = DB::table('projects_images')->where('project_id',$wp->pid)->where('image_ext','!=','pdf')->first();
                if($measurement1){
...
if(!Auth::user()->isSubscriptionExpired()){
    ...
    $disabled1 = 0;
                ...
                ?>
                 <li class="@if($disabled1 == 1) disabled @endif" @if($disabled1 == 0) id="workinprogress{{$wp->pid}}" data-id="{{$wp->pid}}" @endif >
                    <div class="col-md-12 m-b-20">
                       <div class="card-sub-custom">
                          <div class="card-block">
                             <div class="row">
...
if(!Auth::user()->isSubscriptionExpired()){
    ...
    $disabled2 = 0;
                ...
                $image3 = DB::table('projects_images')->where('project_id',$com->pid)->where('image_ext','!=','pdf')->first();
        if($image3){
                    ...
                    <div class="col-md-12 m-b-20">
                       <div class="card-sub-custom">
                          <div class="card-block">
                            ...
                            @endif
                                   <div class="f-10"><strong>Measurement profile :</strong> {{ $title2 }}</div>
                                </div>
                             </div>
                          </div>
                          <div class="card-footer-custom">
