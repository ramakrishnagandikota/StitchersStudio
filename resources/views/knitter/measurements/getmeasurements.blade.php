                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    <label for="int1">@if($name == 'bust') {{ucfirst($name)}} / Chest @else {{ucfirst($name)}} @endif
                                       ...
                                       <img src="{{ ($bs->variable_image != 0) ? $bs->variable_image : '' }}" alt="">
...
<script type="text/javascript">
   ...
   /*   $('select').each(function(){
      ...
      $.ajax({
          ...
          data : Data,
          beforeSend : function(){
			$("#confirmMeasurements").prop('disabled',true);
            $(".loading").show();
          },
          success : function(res){
            if(res.status == 'success'){
              var project = localStorage.getItem('project'); 
				if(project == 'true'){
					setTimeout(function(){ window.location.assign('{{url("knitter/create-project")}}'); },2000);
          ...
          error : function(jqXHR){
            $("#confirmMeasurements").prop('disabled',false);
          }
      });
   }
