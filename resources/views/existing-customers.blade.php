...
<section class="contact m-t-30 primaryc" >
    <div class="container">
      <div class="col-lg-12" style="margin-top:40px"><h2>Getting started on mobile</h2>
      </div>
    </div>
  </section>
          ...
          <div class="container m-t-20">
            <div class="row justify-content-md-center">
              <div class="col-lg-7 my-auto">
                <p>To get your first custom sized pattern, head over to the <a href="{{ url('shop-patterns') }}">KnitFit pattern shop</a>. The link will open in a browser.</p>
  ...
  <section class="footer m-t-15" >
      <div class="container text-center">
       <p><a href="{{ url('shop-patterns') }}" type="button" class="btn theme-btn">Shop pattern</a></p>
      <br><br>
  </div>
  <!-- <div class="col-lg-2 col-md-2 col-sm-1"></div> -->
<!-- </div> -->
