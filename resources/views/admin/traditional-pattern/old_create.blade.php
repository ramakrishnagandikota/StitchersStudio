                                ...
                                <div class="col-md-6 m-b-20">
                                    ...
                                    <select type="text" class="form-control" id="designer_name" name="designer_name">
                                        ...
                                        @foreach($designerUsers as $des)
                                            <option value="{{ $des->id }}">{{ $des->first_name }} {{ $des->last_name
                                            }}</option>
                                        @endforeach
                                    </select>
                                </div>
            ...
            $.ajax({
                ...
                success : function (res){
                    if(res.status == 'success'){
						...
						$("#paypal_username").val(res.paypal_username);
                        $("#paypal_password").val(res.paypal_password);
                        $("#paypal_secret").val(res.paypal_secret);
                        $("#paypal_app_id").val(res.paypal_app_id);
                        $(".test_paypal").addClass('hide');
                        $(".edit_paypal").removeClass('hide');
