...
@section('section1')
    <div class="card col-md-12 col-lg-12 col-xlg-12 col-sm-12 col-xs-12">
        <div class="row">
		<!--<input type="text" value='{{ encrypt("Cheppanu@123") }}'>-->
                        ...
                        <div id="collapse1" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 m-b-20">
                                        <label class="">About pattern<span class="required">*</span>
                                        </label>
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4 m-b-20">
                                        ...
                                        <select class="form-control" name="status" id="status" @if($product->in_review == 0) disabled @endif >
...
<span class="tooltip-text" style="width: 100%;">Select the needle size from the dropdown.</span>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="stitch_gauge_in" name="stitch_gauge_in">
                                                                ...
                                                                @foreach($gaugeconversion as $gc1)
                                                                    <option value="{{$gc1->id}}" {{ ($gc1->id ==
                                                                    $product->recommended_stitch_gauge_in) ? 'selected' : '' }}
                                                                    >{{$gc1->stitch_gauge_inch .' / 1 inches'}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="stitch_gauge_cm" name="stitch_gauge_cm">
                                                                ...
                                                                @foreach($gaugeconversion as $gc3)
                                                                    ...
                                                                    $product->recommended_stitch_gauge_cm) ? 'selected' : '' }}>{{$gc3->stitches_10_cm
                                                                    .' / 10cm'}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="row_gauge_cm" name="row_gauge_cm">
                                                                ...
                                                                @foreach($gaugeconversion as $gc4)
                                                                    <option value="{{$gc4->id}}" {{ ($gc4->id ==
                                                                    $product->recommended_row_gauge_cm) ? 'selected' : '' }}>{{$gc4->rows_10_cm
                                                                    .' / 10cm'}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                    ...
                    <!-- <div class="card">
                        ...
                        <div id="collapse5" class="collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="card-body">
                                <div class="row">
                                    @if($product->patternInstructions()->count() > 0)
                                        @foreach($product->patternInstructions as $inst)
                    ...
                    <div class="card">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select" multiple="multiple" id="users_list" name="users_list[]" style="width: 100%;">
                                                    @foreach($users as $user)
                                                        <option value="{{ $user->id }}" @if($product_access) @foreach($product_access as $pa) @if($pa->user_id == $user->id) selected @endif @endforeach @endif >{{$user->id}} - {{ ucfirst($user->first_name) }} {{$user->last_name}} - {{$user->email}}</option>
                                                    @endforeach
                                                </select>
                        ...
                        <div class="card">
                            ...
                            <div id="collapse8" class="collapse" role="tabpanel" aria-labelledby="headingThree1">
                                <div class="card-body">
                                    <div class="row">
                                        <input type="hidden" id="paypal_verified" value="{{ $paypalDetails ?
                                        $paypalDetails->status : '' }}" >
                                        <input type="hidden" name="paypal_id" value="{{ $paypalDetails ?
                                        $paypalDetails->id : '' }}">
                                        <div class="form-group col-md-6 m-b-20">
                                            ...
                                            <input type="text" name="store_name" id="store_name"
                                                   ...
                                                   value="{{ $paypalDetails ? $paypalDetails->store_name: '' }}"
                                                   readonly >
                                        ...
                                        <div class="form-group col-md-6 m-b-20">
                                            ...
                                            paypal_credentials" readonly>
                                                <option value="">Please select store status</option>
                                                @if($paypalDetails)
                                                <option value="1" @if($paypalDetails->store_status == 1) selected @endif
                                                    >Active</option>
                                                <option value="0" @if($paypalDetails->store_status == 0) selected
                                        ...
                                        <div class="form-group col-md-6 m-b-20">
                                            ...
                                            paypal_credentials" readonly>
                                                ...
                                                @if($paypalDetails)
                                                <option value="personal" @if($paypalDetails->account_type == 'personal') selected @endif>Personal</option>
                                                <option value="business" @if($paypalDetails->account_type == 'business') selected @endif>Business</option>
                                                @else
                                        ...
                                        <div class="form-group col-md-6 m-b-20">
                                            ...
                                            <input type="text" name="paypal_email" id="paypal_email"
                                                   ...
                                                   value="{{ $paypalDetails ? $paypalDetails->paypal_email : '' }}" readonly>
                        ...
                        <div class="m-t-20">
                            <div class="col-sm-12">
                                <div class="text-center m-b-10">
                                    <button type="submit" data-type="save" class="btn theme-btn btn-primary waves-effect waves-light m-l-10 save" >Save or Update</button>
                                  <!--  
									&nbsp;
                                    @if($product->status == 0)
                                        @if($product->in_review == 0)
                                    <button type="button" class="btn theme-btn btn-warning
                                    waves-effect waves-light m-l-10 changePatternStatus" data-id="review_admin" >Send to review for admin</button>
                                        @else
                                            @if($product->in_review_designer == 0)
                                                <button type="button" class="btn theme-btn btn-success
                                waves-effect waves-light m-l-10 changePatternStatus" data-id="review_designer" >Send designer for review</button>
                                            @endif
                                        @endif
                                            @if($product->in_review == 1 && $product->in_review_designer == 1)
                                    <button type="button" class="btn theme-btn btn-danger
                                    waves-effect waves-light m-l-10 changePatternStatus" data-id="live">Make pattern live</button>
                                            @endif
                                    @endif -->

@if(!$status2 && $status1)
    <button class="btn theme-btn btn-success waves-effect waves-light m-l-10 changePatternStatus" data-id="2">Approve pattern for submission</button>

    <button class="btn theme-btn btn-danger waves-effect waves-light m-l-10 changePatternStatus" data-id="3">Reject pattern </button>
@endif

@if($status4 && !$status5)
 <button class="btn theme-btn btn-warning waves-effect waves-light m-l-10 changePatternStatus" data-id="5">Send designer for review </button>
@endif

@if($status5 && !$status6)
 <button class="btn theme-btn btn-warning waves-effect waves-light m-l-10 changePatternStatus" data-id="6">Approved for release </button>
@endif
    ...
    <script>
        $(function (){
            ...
            $validations.bootstrapValidator({
                ...
                $.post($form.attr('action'), $form.serialize(), function(result) {
                    if(result.status == 'success'){
                        ...
                        $(".loading,.loader-bg").hide();
                        notification('fa-times','Oops..',result.message,'warning');
                    }else{
						$(".loading,.loader-bg").hide();
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.post('{{ route("admin.make.image.default") }}', Data, function(result) {
                            if(result.status == 'success'){
								$(".primaryImage").removeClass('fa-star').addClass('fa-star-o');
								$(".primaryImage").attr('data-mainphoto',0);
			...
			$(document).on('click','.deleteRefImage',function(){
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        if(server){
                            $(".loading").show();
                            $.get('{{ url("admin/delete-pattern-reference-image")  }}/'+id,function (res){
                                if(res.status == 'success'){
			...
			$(document).on('click','.changePatternStatus',function (){
                ...
                $.ajax({
                    url : '{{ route("admin.sendReviewOrChangeStatus") }}',
                    type: 'POST',
                    data: 'statusType='+dataId+'&product_id='+product_id,
                    beforeSend : function (){
                        $(".changePatternStatus").prop('disabled',true);
                        $(".loading").show();
                    },
                    success : function (res){
                        if(res.status == 'success'){
                            notification('fa-check','success',res.message,'success');
                    ...
                    complete : function (){
                        $(".loading").hide();
                        setTimeout(function (){ $(".changePatternStatus").prop('disabled',false); },2000);
                    }
                });
            });
