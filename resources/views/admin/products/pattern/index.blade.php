...
<!--<script src="https://cdn.tiny.cloud/1/g6thwa9et390euif6ovjofrsailpg8o5kijl7gjgbibt94kx/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>-->
<script src="{{ asset('resources/assets/htmleditor/js/tinymce.min.js') }}" referrerpolicy="origin"></script>
...
.mce-notification-inner,.mce-notification-warning{
	display:none;
}
#pattern-content{
	display:none;
...
<div class="view">
<iframe class="img-responsive" src="https://maps.google.com/maps?q=12.927923,77.627108&z=15&output=embed"  frameborder="0" allowfullscreen data-url=""></iframe>
</div>
</div>
<!-- code -->
...
<p style="text-align:center;">Are you sure want to save this pattern.</p>
</div>
