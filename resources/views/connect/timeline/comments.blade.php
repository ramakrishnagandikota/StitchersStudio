...
@endphp
        <a href="javascript:;" class="@if($comlikesByme == 0) like-comment @else unlike-comment @endif" data-id="{{$com->id}}" id="commentlikable{{$com->id}}" data-timelineid="{{$com->timeline_id}}" >
