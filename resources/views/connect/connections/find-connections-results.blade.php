<div class="col-md-12">
	<h5 class="m-b-25 theme-heading" >Search results for : {{$search}} 
		@if(count($users) == 0)
		<span class="pull-right">No results found for the search criteria</span>
		@else
		<span class="pull-right">No of Results : ( {{count($users)}} )</span>
		@endif
	</h5>
</div>
@if($users)
