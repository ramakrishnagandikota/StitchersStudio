...
<form class="md-float-material form-material" method="POST" action="{{url('register')}}" autocomplete="no">
    ...
    <div class="auth-box card">
        <div class="card-block custom-padding">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-primary">
                        <input type="text" id="first_name" name="first_name" class="form-control {{old('first_name') ? 'fill' : ''}}" min="2" max="15" value="{{old('first_name')}}" >
                ...
                <div class="col-md-6">
                    <div class="form-group form-primary">
                        <input type="text" id="last_name" name="last_name" class="form-control {{old('last_name') ? 'fill' : ''}}" value="{{old('last_name')}}" >
                        <i class="fa fa-info pophover" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Name should contain only letters and have a maximum length of 15 characters."></i>
                        <span class="form-bar"></span>
                    ...
                    <div class="form-group form-primary">
                        <input type="text" id="username" name="username" class="form-control {{old('username') ? 'fill' : ''}}" value="{{old('username')}}" >
            ...
            <div class="form-group form-primary">
                <input type="text" name="email" id="email" class="form-control {{old('email') ? 'fill' : ''}}" value="{{old('email')}}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$">
                ...
                <span class="red" id="emailValidate">@if($errors->first('email')) {{$errors->first('email')}} @endif</span>
            </div>
            <div class="row m-b-5">
                <div class="col-sm-6">
                    <div class="form-group form-primary">
                ...
                <div class="col-sm-6">
                    <div class="form-group form-primary">
                       ...
                       <!--  <i class="fa fa-info pophover" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Password and Confirm Passwors should match."></i> -->
                        ...
                        <span class="red" id="cnfm_pwd">@if($errors->first('confirm_password')) {{$errors->first('confirm_password')}} @endif</span>
                    </div>
                </div>
