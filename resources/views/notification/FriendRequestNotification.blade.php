...
<a href="{{url('connect/friend-requests')}}" style="padding: 0px !important;"><h5 class="notification-user"> {{ ucfirst($notification->data['requestSentBy']['first_name']) }} {{ $notification->data['requestSentBy']['last_name'] }}</h5></a>
