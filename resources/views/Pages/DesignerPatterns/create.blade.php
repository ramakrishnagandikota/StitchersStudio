                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="tab-content card-block">
                                ...
                                <div class="tab-pane active show" id="basic-p-details" role="tabpanel">
                                    <form class="form-horizontal" id="create-pattern" action="{{ url('designer/save-pattern') }}">
                                                    ...
                                                    <div class="step">
                                                        <div class="form-group row">
                                                            <div class="col-md-6 m-b-20">
                                                                ...
                                                                <input type="text" id="product_name" name="product_name" class="form-control" value="" placeholder="Enter pattern name">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <textarea type="text" id="about_description" class="form-control" name="about_description" required="" placeholder="Tell us a little bit about this design." spellcheck="false"></textarea>
                                                            </div>
                                        ...
                                        <div class="form-group m-t-20">
                                            <div class="col-sm-12">
                                                <div class="text-center m-b-10">
                                                    <button type="submit" class="btn theme-btn btn-primary waves-effect waves-light m-l-10" id="next-step1">Submit basic details</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                $validations.bootstrapValidator({
                    ...
                    $.post($form.attr('action'), $form.serialize(), function(result) {
                        if(result.status == 'success'){
                            ...
                            notification('fa-check','Yay..','Pattern submitted successfully. We will notify you once your pattern approved.','success');
