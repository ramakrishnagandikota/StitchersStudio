    ...
    <div class="container">
        <div class="row card">
            <div class="payment-box text-center p-40">
                ...
                <p><a href="{{ url('retry/order/'.$orders->order_number) }}"
                      class="btn btn-sm theme-outline-btn">&nbsp; Retry&nbsp;payment</a></p>
                <p><a href="{{url('shop-patterns')}}" class="btn theme-outline-btn waves-effect waves-light m-l-20 m-b-10 m-t-20">Continue shopping</a></p>
        </div>
        </div>
    </div>
</section>
