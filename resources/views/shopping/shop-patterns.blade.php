...
<div class="row outline-row m-b-10" data-toggle="collapse" data-target="#section12">
<div class="accordion col-lg-11 p-r-0 p-l-0">
...
<div class="collapse show" id="section12">
<div class="m-b-10">
<div class="row">
<div class="col-lg-12 col-sm-12">
<div class="list-group-item">
...
<div class="row outline-row m-b-10" data-toggle="collapse" data-target="#section221">
<div class="accordion col-lg-11 p-r-0 p-l-0">
...
<div class="collapse show" id="section221">
<div class="m-b-10">
<div class="row">
<div class="col-lg-12 col-sm-12">
<div class="list-group-item">
...
$showProduct = '';
$designername = App\User::where('id',$pro->designer_name)->first();
@endphp
		

<div class="col-xl-3 col-md-6 col-grid-box sectionContent {{$designername ? $designername->username : ''}}  {{$gartype}} {{$garcons}} {{$desielem}} {{$shouldcons}} {{$custom}} {{$pro->id}} ">
<div class="product-box">
    <div class="img-wrapper">
		...
		<!-- $booking = App\Models\Booking_process::where('user_id',Auth::user()->id)->where('product_id',$pro->id)->count(); -->
@php
    if(Auth::check()){
...
@endauth
    ...
    <div class="product-detail">
        <div>
			...
			<a href="javascript:;"><h6>By @if($designername){{ ucwords($designername->first_name.' '.$designername->last_name) }} @else  Unknown @endif</h6></a>
            
            
            <p>{!! Str::limit($pro->product_description,200) !!} </p>
...
<div class="col-xl-4 col-md-4 col-sm-12">
    <div class="product-search-count-bottom">
        <h5>Showing Products {{$paginator->currentPage()}} - {{$paginator->count()}} of {{$paginator->lastPage()}} Result</h5></div>
</div>
</div>
</div>
</div>
...
<script type="text/javascript">
	...
	$(function(){
        ...
        if(id == 0){
            addProductCartOrWishlist('fa-times','Oops!','This product is already purchased.','danger');
            return false;
        }
        ...
        $.ajaxSetup({
            ...
            $.ajax({
                ...
                success : function(res){
                    if(res.error == 'fail'){
                       addProductCartOrWishlist('fa-times','Oops!',res.message,'danger');
                    }else{
