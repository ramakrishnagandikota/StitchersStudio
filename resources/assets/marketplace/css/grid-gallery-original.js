...
for(var i = 0; i < l; i++) {
  images[i].addEventListener("click", function(i) {
    ...
    screenItem.innerHTML = '<div class="gg-image"></div><div class="gg-close gg-btn" style="z-index:99999">&times</div><div class="gg-next gg-btn" style="z-index:99999">&rarr;</div><div class="gg-prev gg-btn" style="z-index:99999">&larr;</div><div class="gg-image-right" "><div class=""> <div class="timeline-details">'
