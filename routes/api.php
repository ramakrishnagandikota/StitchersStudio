...
Route::get('login/{user_id}', 'API\LoginController@login_with_user_id');
...
Route::post('login/apple','API\LoginController@apple_login');

Route::get('profile/verify-user/{token}','API\LoginController@verify_user');
...
Route::group(['middleware' => 'auth:api'], function(){
	...
	Route::post('update-app-rating','API\MeasurementsApiController@update_app_rating');
...
Route::get('externalProjectData/{uom}','API\ProjectsController@get_external_data');

Route::post('create-custom-project','API\ProjectsController@create_custom_project');
Route::post('create-non-custom-project','API\ProjectsController@create_non_custom_project');
...
Route::post('delete-project-image','API\ProjectsController@delete_project_image');
...
Route::post('update-download-status','API\ProjectsController@updateDownloadStatus');
/* project library */
...
Route::post('profile/update-names','API\UserController@update_names');
Route::post('profile/validate-user','API\UserController@validate_user');
/* address */
...
Route::post('addProductToProjectLibrary','API\CheckoutController@add_to_project_library');
/* my orders */

/* timeline */
Route::get('connect','API\ConnectController@index');
...
Route::get('get-all-comments/{timeline_id}','API\ConnectController@get_all_comments');
...
Route::post('paypalCreateSubscription','API\PaypalSubscriptionController@createSubscription');
...
Route::get('downloadPDF/{id}','API\ProjectsController@downloadPatternPDF');
